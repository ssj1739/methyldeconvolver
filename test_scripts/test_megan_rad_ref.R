...
pat.dir <- "~/Data/TestMixIn/from_megan_rad/Reference/ALL/CopyPAT/final_PAT_reference_SJ_Jan2023/pat/original_pats/"
...
#
 ...
 closepb(pb)
saveRDS(result_deconv_self, file = "data/All_results_full_ref_5-2-23.rds")
# 
